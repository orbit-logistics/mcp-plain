...
- `upsert_help_center_article` - Create or update an article (new articles default to DRAFT; updates keep the article's current status and group unless you pass them)
